                        ...
                        <ul>
                            @foreach($discount_by_days as $type)
                                <li>
                                    <div class="label">
                                        @if(!$type['to'])
                                            {{__('from :from',['from'=>$type['from']])}} {{ setting_item("space_booking_type",'by_day') == "by_day" ? __("day") : __("night") }}
                                        @else
                                            {{__(':from - :to',['from'=>$type['from'],'to'=>$type['to']])}} {{ setting_item("space_booking_type",'by_day') == "by_day" ? __("day") : __("night") }}
                                        @endif
                                        :
                                    </div>
                                    <div class="val">

<div class="card w-100 shadow-hover-3 mb-5 {{$wrap_class ?? ''}}">
	...
	<div class="mb-3">
		...
		<div class="d-flex justify-content-center mx-3">
			@if($row->can_book)
			<a data-id="{{$row->id}}" href=""  onclick="event.preventDefault()" class="btn btn-blue-1 font-size-14 width-260 text-lh-lg transition-3d-hover py-1 btn-choose-flight">{{__("Choose")}}</a>
			@else

        ...
        <div id="bravo_space_book_app" class="bravo_single_book " v-cloak>
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        <span class="d-block text-gray-1 font-weight-normal mb-0 text-left">{{ __("Check In - Out") }}</span>
                        <div class="mb-4">
                        ...
                        <div class="mb-4 border-bottom border-width-2 border-color-1 pb-1" v-if="discount_by_days_output.length">
                            <h4 class="flex-center-between mb-1 font-size-16 text-dark font-weight-bold">{{__('Discounts:')}}</h4>
                            <div class="extra-price-wrap d-flex justify-content-between mb-2" v-for="(type,index) in discount_by_days_output">
                                <div class="flex-grow-1">

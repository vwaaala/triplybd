...
class FormSearchAllService extends BaseBlock
{
    function getOptions()
    {
        ...
        $arg[] =  [
            'id'            => 'bg_opacity',
            'type'          => 'radios',
            'label'         => __('Background effect opacity'),
            'values'        => [
                [
                    'value'   => '0.1',
                    'name' => __("No transparent")
                ],
                [
                    'value'   => '0.4',
                    'name' => __("Effect opacity 40%")
                ],
                [
                    'value'   => '0.5',
                    'name' => __("Effect opacity 50%")
                ],
                [
                    'value'   => '0.6',
                    'name' => __("Effect opacity 60%")
                ],
                [
                    'value'   => '0.7',
                    'name' => __("Effect opacity 70%")
                ],
            ]
        ];
    ...
    public function content($model = [])
    {
        ...
        $model['bg_opacity'] = $model['bg_opacity'] ?? "0.5";

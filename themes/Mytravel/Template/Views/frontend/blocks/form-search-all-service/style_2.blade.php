<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom text-center z-index-2 position-relative" style="background-image: url('{{$bg_image_url}}') !important;">

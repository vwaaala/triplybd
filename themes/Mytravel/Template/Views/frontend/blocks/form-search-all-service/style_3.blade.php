<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom position-relative text-center z-index-2" style="background-image: url('{{$bg_image_url}}') !important;">

<div class="bravo-form-search-all slider-carousel hero-block hero-v1 position-relative bg-img-hero-bottom text-center z-index-2">
    <div class="effect ">
        <div class="owl-carousel">
            @foreach($list_slider as $item)
                @php $img = get_file_url($item['bg_image'],'full') @endphp
                <div class="item position-relative" style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('{{$img}}') !important">
                    <div class="effect-bg position-absolute top-0 left-0 right-0 bottom-0 z-0" style="background:#000 ; opacity: {{ !empty($bg_opacity) ? $bg_opacity : "0.5" }}"></div>
                    <div class="pb-10 z-index-2 position-relative">
